...
const BASE_URL = 'http://192.168.1.6:8081';
...
const CreateRecord = () => {
    ...
    const handleSubmit = () => {
      ...
      axios.post(`${BASE_URL}/records`, payload)
        .then(() => {
          Alert.alert('Sucess! Data Saved.');
          setName('');
          setAge('');
          setSelectedGame('');
          setPlatform(undefined);
        })
        .catch(() => Alert.alert('Data not saved. Try Again'));
        ...
        useEffect(() => {
            axios.get(`${BASE_URL}/games`)
              ...
              .catch(() => Alert.alert('Error! Games not listed. Try Again'));
